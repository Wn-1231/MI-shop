...
function sendCode(phone, code, callback) {
    var ACCOUNT_SID = '8a216da86f0d2e39016f0f5590850351'; // 可以改成自己的
    var AUTH_TOKEN = 'f9852bb09fdc45749a8fb715d051d4cf'; // 可以改成自己的
    var Rest_URL = 'https://app.cloopen.com:8883';
    var AppID = '8a216da86f0d2e39016f0f5590e30357'; // 可以改成自己的
    //1. 准备请求url
    /*
